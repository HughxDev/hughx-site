...
const Intro = ( props ) => (
  <Article>
    ...
    { /* <a href="https://instagram.com/p/CKZ1maxsqWL/">fighting games</a> */ }
    <p>Hi, my name’s Hugh Guiney (<abbr style={ { "borderBottom": 0 } } title="pronounced">🗣 </abbr>GUY-knee). I’m a UX Developer, which means I design and code thoughtful digital products. I’ve worked with organizations of all sizes, from startups to <abbr>SMBs</abbr> to household names. In my spare time I build open-source software, play fighting games, and <a href="https://imdb.me/hugh">make movies</a>.</p>
    <Brands mode="casual" />
  </Article>
);
