...
const Intro = ( props ) => (
  <Article>
    ...
    <p>Hi, my name’s Hugh Guiney (<abbr style={ { "borderBottom": 0 } } title="pronounced">🗣 </abbr>GUY-knee). I’m a UX Developer, which means I design and code thoughtful digital products. I’ve worked with organizations of all sizes, from startups to <abbr>SMBs</abbr> to household names. In my spare time I build open-source software, play <a href="https://instagram.com/p/CKZ1maxsqWL/">fighting games</a>, and <a href="https://nospoon.productions/">make movies</a>.</p>
    <Brands mode="casual" />
  </Article>
);
